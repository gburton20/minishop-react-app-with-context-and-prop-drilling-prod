...
function App() {
  ...
  // A function to openModal(). This function will be called when the user clicks the AuthButton.jsx component. The return value of this function is setting the isAuthModalOpen state to true:
  // const openModal = () => {
  //   console.log('openModal called');
  //   setIsAuthModalOpen(true)
  // }

  // A function to closeModal(). This function will be called when the user; i) clicks the 'X' in the corner of the modal, ii) clicks outside of the modal or iii) presses the ESC button on their keyboard. The return value of this function is setting the isAuthModalOpen state to false.
  // const closeModal = () => {
      ...
      <div>
        ...
        {/* The AuthModal component should sit at a high level in the component tree, so that it isn't unmounted when navigating between routes */}
          ...
          <Navbar
            // isAuthModalOpen={isAuthModalOpen}
            // setIsAuthModalOpen={setIsAuthModalOpen}
            // We only need to pass openModal() to the Navbar, as we will only ever be opening the modal from the AuthButton.jsx component
            // openModal={openModal}
            // We need to pass the navCartAddCount state to CartItemCounter.jsx as a prop via Navbar.jsx > CartItemCounter.jsx so that it is accessible within that component for rendering.
        ...
        <Routes>
          ...
          <Route 
            path="/" 
            element={<Home 
              // Pass the handleAddToCart function as a prop to ProductCard.jsx via Home.jsx > ProductCardList.jsx.
              // Each time handleAddToCart is executed within ProductCard.jsx, the setCartState and setNavCartAddCount set state variables are executed also, meaning we do not need to also pass the state variables as props to ProductCard.jsx.
